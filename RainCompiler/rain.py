...
class Lexer:
	...
	def make_not_equals(self):
		...
		self.Advance()
		return None,ExpectedCharError(position_start,self.pos, "'='(after'!')") # so if there is  equals  return no token with error
...
class ParseResult:
	...
	def register(self, res):
		self.Advance_count += res.Advance_count#error
